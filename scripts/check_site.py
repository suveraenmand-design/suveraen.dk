...
for path in ('404.html','robots.txt','sitemap.xml','CNAME','assets/images/favicon.svg','assets/images/social-card.webp','assets/images/book-cover.webp','.github/workflows/pages.yml'):
